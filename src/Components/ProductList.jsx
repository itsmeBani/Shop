...
const  {clientsession, setclientsession,cartLength
    ...
    const filteredProducts = category
        ? fetchproducts.filter(product => product.label.toLowerCase() === category.toLowerCase())
        : fetchproducts;
      ...
      <div className="flex gap-2  w-full   place-items-center justify-end p-2">
          <div className="w-52">
              <div className="relative w-full min-w-[200px] h-10">
                  <div
                      className="absolute grid w-5 h-5 place-items-center bg-none top-2/4 right-3 -translate-y-2/4">
          ...
          <div className="flex  gap-2  ">
              ...
              <Badge content={cartLength} invisible={cartLength==null}>
                  <Button className="rounded-lg px-3 " onClick={() => {
                      setcart(true)
                  }}>
         ...
         <div className="grid grid-cols-2 h-screen md:grid-cols-2 lg:grid-cols-3 gap-4 py-2 overflow-y-scroll  ">
