                ...
                <DialogBody className="p-0 h-auto  pb-10 px-" >
                                ...
                                <div className="md:flex-1 px-4">
                                    ...
                                    <div className="flex mb-4">
                                        <div className="mr-4">
                                            ...
                                            <span className="text-gray-600 dark:text-gray-300">P{price}</span>
                                        </div>
                                        <div>
                                            <span
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="flex items-center mt-2">
                                            <div
                                                className="bg-gray-300 dark:bg-gray-700 text-gray-700 dark:text-white py-2 px-4 rounded-full font-bold mr-2  dark:hover:bg-gray-600">{label}
                                            </div>
                    ...
                    <div className=" flex  w-full fixed bg-white bottom-0 right-0 block  gap-2 ">
                        <div className="flex w-full p-3 place-items-center justify-end ">
                            ...
                            <h1  className="text-blue-500 text-lg font-bold">₱{price }</h1>
                        </div>
