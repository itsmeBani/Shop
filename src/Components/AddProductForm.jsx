...
import {AddProduct} from "../AxiosAdmin.js";
import SuccessAlert from "./SuccessAlert.jsx";

function AddProductForm({setOpenForm, refresh,setrefresh}) {
    ...
    const handleSelectChange = (value) => {
        setProductData({ ...productData, label: value });
    };
    ...
    const SubmitAddProduct = async (e) => {
        e.preventDefault();
        try {
            const { imageUrl, name, description,label, price } = productData;
            const response = await AddProduct(imageUrl, name, description, label, price);
    ...
    <div className="py-10 px-5 w-full flex gap-3  place-items-center flex-col">
        ...
        <div className="w-full flex  gap-2">
            <div className=" w-full ">
                ...
                {imageError || !productData.imageUrl ? (
        ...
        <div className="w-full">
            <Select label="Category" value={productData.label} onChange={handleSelectChange}>
